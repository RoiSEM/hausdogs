...
<main id="primary" class="site-main">
  ...
  <section class="banner style1 orient-left content-align-left image-position-right fullscreen onload-image-fade-in onload-content-fade-right">
    <div class="content">
      <h1>Welcome to Haus Dogs</h1>
      <p class="major"> We are a family owned and operated dog daycare and boarding facility located in the heart of the city. We are dedicated to providing the best possible care for your furry friends. Early bird specials available!</p>
      <ul class="actions stacked">
        <li><a href="https://forms.gle/JCGMEGUR1Sb9TSHL8" class="button large wide smooth-scroll-middle" target="_blank">Get Started</a></li>
      </ul>
    </div>
    <div class="image">
  ...
  <section class="wrapper style1 align-center">
    <div class="inner">
      <h2>Our Facility</h2>
      <p>Our facility is a state of the art facility that is designed to provide the best possible care for your furry friends. We have a variety of playzones for your dog to play in. Please contact us to inquire about our playzone options. </p>
    </div>
